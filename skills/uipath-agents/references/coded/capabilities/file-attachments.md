...
- Never instantiate `UiPath()` at module level; `uip codedagent init` imports `main.py` to introspect schemas.

## References

- SDK attachments API: https://uipath.github.io/uipath-python/core/attachments/
